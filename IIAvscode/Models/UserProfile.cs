...
{ /// <summary>
  ...
  /// </summary>
    public class UserProfile
    {
        ...
        public UserProfile(int id, string phoneNumber, string membershipId, int membershipAdmissionfee, int membershipFees, int membershipCurrentExpiryYear, DateTime membershipJoinDate, DateTime membershipRenewDate, string membershipExpiryYears, int profileStatus, int chapterId, string chapterName, string unitName, string gstin, string gstCertPath, string industryStatus, string address, string district, string city, string state, string country, string pincode, string websiteUrl, string productCategory, string productSubCategory, string majorProducts, string annualTurnOver, string enterpriseType, string exporter, string classification,  string firstName, string lastName, string email, string profileImagePath, string financialProofPath, string signaturePath, int createdBy, int updatedBy, DateTime createdDate, DateTime updatedDate)
        {
            this.Id = id;
        ...
        public int MembershipAdmissionfee { get; set; }
