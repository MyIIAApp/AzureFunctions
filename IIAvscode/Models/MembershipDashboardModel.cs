...
namespace IIABackend
{
    ...
    public class MembershipDashboardModel
    {
        ...
        public MembershipDashboardModel(string totalMembers, string totalMembersChapterLevel, string activeMembers, string membersUnderGracePeriod, string expiredMemberships, string usersLoggedinButNotMembers, string newMembers, string pendingRequests)
        {
