...
{ /// <summary>
  ...
  /// </summary>
    public class ActiveMembershipResponse
    {
        ...
        public ActiveMembershipResponse(int userId, string firstName, string lastName, string email, string membershipId,  int chapterId, string chapterName, int membershipFees, DateTime membershipExpiryDate, DateTime membershipSince, int membershipStatus)
        {
            this.UserId = userId;
