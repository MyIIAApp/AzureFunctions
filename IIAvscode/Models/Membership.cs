...
{ /// <summary>
  ...
  /// </summary>
    public class Membership
    {
        ...
        public Membership(int userId, string firstName, string lastName, string email, string membershipId,  int chapterId, string chapterName, int membershipAdmissionFee, int membershipFees, int membershipExpiryYear, DateTime membershipRenewDate, DateTime membershipJoinDate, int createdBy)
        {
            this.UserId = userId;
