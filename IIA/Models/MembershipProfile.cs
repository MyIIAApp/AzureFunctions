...
{ /// <summary>
  ...
  /// </summary>
    public class MembershipProfile
    {
        ...
        /// <param name="dateOfMarriage">dateOfMarrage</param>
        ...
        public MembershipProfile(int id, int profileStatus, int chapterId, string chapterName, string unitName, string gstin, string gstCertPath, string industryStatus, string address, string district, string city, string state, string country, string pincode, string websiteUrl, string productCategory, string productSubCategory, string majorProducts, string annualTurnOver, string enterpriseType, string exporter, string classification,  string firstName, string lastName, string email, DateTime? dateOfBirth, DateTime? dateOfMarriage, string profileImagePath, string financialProofPath, string signaturePath, int createdBy, DateTime createdDate, DateTime updatedDate, string phoneNumber)
        {
            this.Id = id;
        ...
        public MembershipProfile(dynamic data, int id)
        {
            ...
            string dom = data?.dateOfMarriage.ToString();
